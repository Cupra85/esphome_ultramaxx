...
static const char *const ULTRAMAXX_VERSION = "UltraMaXX Parser v5.11";
...
void UltraMaXXComponent::loop() {
  ...
  // ======================================================
  // RX STREAM PARSER (LIVE BYTE PARSING)
  // ======================================================

  while (this->available()) {

    uint8_t c;
    if (!this->read_byte(&c)) continue;

    // Wakeup Müll ignorieren bis Longframe beginnt
